    ...
    <div className="row">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              className={
                state.name ? "form-control is-invalid" : "form-control"
              }
              id="name"
              name="name"
              value={name}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className={
                state.password ? "form-control is-invalid" : "form-control"
              }
              id="password"
              name="password"
              value={password}
          ...
          <div className="text-center">
            <button className="btn btn-primary m-auto mt-3">
              Register Here
            </button>
          </div>
        </form>
      ...
      <div className="col-md-6 ">
        <img
          ...
          src="https://res.cloudinary.com/bangla-company/image/upload/v1641724207/twinkls%20cats/Screenshot_1_vjemff.png"
          alt=""
        />
      </div>
    </div>
