  ...
  return (
    <>
      <div className="d-flex justify-content-evenly mt-5 mb-3">
        <img
          style={{
            boxShadow: "0px 1px 18px 17px #ddd",
            border: "2px solid",
            width: "60px",
            height: "60px",
            borderRadius: "50%",
          ...
          src={
            state.user.email === "remonroy34@gmail.com"
              ? "https://res.cloudinary.com/bangla-company/image/upload/v1641456449/avators/xogqdaw7r1tgv54gh4wn.jpg"
              : "./Profile.png"
          }
          alt=""
        />
